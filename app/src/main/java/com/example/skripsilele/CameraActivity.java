...
public class CameraActivity extends org.opencv.android.CameraActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("CameraActivity", "onCreate: OpenCV initialization status: " + OpenCVLoader.initDebug());
        getPermission();
        is_init = false;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        Log.d("CameraActivity", "onRequestPermissionsResult: " + requestCode);
        if (requestCode == 101) {
            if (grantResults.length > 0 && grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Log.e("CameraActivity", "Permission denied for camera");
                getPermission();
            } else {
                Log.d("CameraActivity", "Permission granted for camera");
            }
        }
    }
